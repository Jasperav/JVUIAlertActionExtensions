#
# Be sure to run `pod lib lint JVUIAlertActionExtensions.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of JVUIAlertActionExtensions.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'JVUIAlertActionExtensions' => ['JVUIAlertActionExtensions/Assets/*.png']
  # }
